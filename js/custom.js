...
$(function() { 
  ...
  $(".switcher").click(function() {  
	...
	$('.menu__level[data-menu="main"]').addClass("menu__level--current");	
	$(".menu__breadcrumbs").find("a:gt(0)").each(function(){
		$(this).remove();
		});
...
$(".doc-options .tab-icons").click(function() {  
	...
	$(".doc-options .box-content").toggle(200);
});
});
...
$(document).ready(function() {
    ...
    $('.certificate-print').css('height', $(window).height()-330);
    $(window).resize(function(){
        $('.certificate-print').css('height', $(window).height()-330);
	});
...
;(function($){    
	...
	setTimeout(function() {
      $('.transactions').addClass("fadeInDown go animated");
    }, delay+=150 );
  });	
		});
        return that;
...
(function($){
   ...
   setTimeout(function() {
      $('.transactions').removeClass("fadeInDown go animated");
...
// css load for details cards	
	...
	setTimeout(function() {
      $('.card.md').addClass("fadeInUp go animated");
    }, delay+=150 );	
  });	
    });
		setTimeout(function() {
