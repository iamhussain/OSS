    ...
    $.fn.extend({
        ...
        jClocksGMT: function( options ) 
        {
            ...
            var defaults = 
            {
                ...
                digital: true,
                analog: true,
                timeformat: '<i>A</i> hh:mm:ss',
                date: true,
                dateformat: 'DD/MM/YYYY <i> الثلاثاء </i>',
                angleSec: 0,
                angleMin: 0,
                angleHour: 0,
                skin: 1,
            ...
            return this.each(function()
            {
                ...
                if( options.analog )
                {
                    ...
                    // create clock face
                    $("<img />", { class: "jcgmt-clock", src: options.imgpath + 'images/jcgmt-' + options.skin + '-clock_face.svg' }).appendTo("#" + id + ' .jcgmt-clockHolder');
                }
